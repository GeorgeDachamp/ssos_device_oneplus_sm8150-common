...
import com.ssos.settings.device.R;
...
public class TouchscreenGestureSettingsActivity extends PreferenceActivity
    ...
    public static class MainSettingsFragment extends PreferenceFragment {
        ...
        private void initTouchscreenGestures() {
            final KryptonHardwareManager manager = KryptonHardwareManager.getInstance(getContext());
        ...
        public static void restoreTouchscreenGestureStates(final Context context) {
            ...
            final KryptonHardwareManager manager = KryptonHardwareManager.getInstance(context);
        ...
        private static boolean isTouchscreenGesturesSupported(final Context context) {
            final KryptonHardwareManager manager = KryptonHardwareManager.getInstance(context);
            return manager.isSupported(KryptonHardwareManager.FEATURE_TOUCHSCREEN_GESTURES);
        }
