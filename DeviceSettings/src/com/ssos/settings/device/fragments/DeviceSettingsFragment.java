...
package com.ssos.settings.device.fragments;
...
import com.ssos.settings.device.Utils;
...
public class DeviceSettingsFragment extends PreferenceFragmentCompat {
    ...
    private void setRefreshRate(int rate) {
        Settings.System.putInt(mContext.getContentResolver(), PEAK_REFRESH_RATE, rate);
        Settings.System.putInt(mContext.getContentResolver(), MIN_REFRESH_RATE, rate);
    }
}
